        ...
        return (
            <View style={styles.container}>
                    ...
                    {hasLogin
                        ...
                        : <View style={styles.userview}>
                            <View style={{flexDirection: 'row',alignItems:'center'}}>
                                <AntDesign name={'user'} size={30} style={{color: 'black',marginRight: 5}}/>
                                <Text style={{marginLeft:10}}>立即登录</Text>
                            </View>
                            <AntDesign name={'right'} size={16} style={{color: '#6d6d6d',marginRight: 5}}/>
                        </View>
                    }
                </TouchableOpacity>
                <View style={{marginTop: 10}}>
                    ...
                    >
                        <View style={{flexDirection: 'row',alignItems:'center'}}>
                            <Entypo name={'palette'} size={20} style={{color: 'black',marginRight: 5}}/>
                    ...
                    <TouchableOpacity
                        ...
                        style={styles.setingview}>
                        <View style={{flexDirection: 'row',alignItems:'center'}}>
                            <Entypo name={'hand'} size={20} style={{color: 'black',marginRight: 5}}/>
                ...
                <View style={{marginTop: 10}}>
                    ...
                    <TouchableOpacity activeOpacity={0.5} style={styles.setingview}>
                        <View style={{flexDirection: 'row',alignItems:'center'}}>
                            <Entypo name={'arrow-up'} size={20} style={{color: 'black',marginRight: 5}}/>
                    ...
                    <TouchableOpacity activeOpacity={0.5} style={styles.setingview}>
                        <View style={{flexDirection: 'row',alignItems:'center'}}>
                            <Entypo name={'tools'} size={20} style={{color: 'black',marginRight: 5}}/>
                    ...
                    <TouchableOpacity activeOpacity={0.5} style={styles.setingview}>
                        <View style={{flexDirection: 'row',alignItems:'center'}}>
                            <Entypo name={'emoji-flirt'} size={20} style={{color: 'black',marginRight: 5}}/>
